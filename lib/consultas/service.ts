...
import type { AsociacionRegionalPlaga, ConsultaInput, ContextoFenologico, EstadoGeneral, EvaluacionPlaga, PrevisionClimaticaDiaria, ReglaAgronomicaV2, ReglaPlaga, ResultadoReglaV2 } from "@/types";
