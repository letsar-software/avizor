...
export function ScopeDisclaimer() { return <div className="mt-8"><InfoMessage icon={ShieldCheck}>Avizor describe condiciones ambientales y no el estado sanitario del lote. No diagnostica ni reemplaza el asesoramiento profesional.</InfoMessage></div>; }
