...
function days(count:number,{hr=75,temp=22,rainDays=0,totalRain=rainDays,min=5}:{hr?:number;temp?:number;rainDays?:number;totalRain?:number;min?:number}={}):SerieClimaticaDiaria[]{return Array.from({length:count},(_,i)=>({fecha:`2026-07-${String(10+i).padStart(2,"0")}`,temperaturaMedia:temp,temperaturaMinima:min,temperaturaMaxima:temp+5,humedadRelativa:hr,precipitacion:i<rainDays?totalRain/rainDays:0,vientoMedio:10,et0:2}));}
