...
with sync_playwright() as p:
    ...
    page = browser.new_page(viewport={"width": 1440, "height": 1100}, extra_http_headers={"x-real-ip": "127.0.0.11"})
    ...
    page.get_by_text("Inicio de formación de vainas", exact=False).wait_for(timeout=30000)
